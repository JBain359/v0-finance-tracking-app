...
export function UploadForm() {
  ...
  const handleDrop = useCallback((e: React.DragEvent) => {
    ...
    if (droppedFile && (droppedFile.type === 'text/csv' || droppedFile.type === 'application/pdf' || droppedFile.name.endsWith('.csv'))) {
      setFile(droppedFile)
      setError(null)
    } else {
        ...
        <div className="space-y-3">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="bank" className="cursor-pointer">Bank Statement</Label>
            </div>
            <div className="flex items-center space-x-2">
